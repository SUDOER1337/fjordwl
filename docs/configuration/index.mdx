---
title: Configuration
description: Configure fjordwl with config files, environment variables, and autostart.
icon: Settings
---

Configure fjordwl through config files, environment variables, and autostart.
