---
title: Configuration
description: Configure fjordwl with `config.h`, environment variables, and autostart.
icon: Settings
---

Configure fjordwl through compile-time `config.h`, environment variables, and autostart.
